#sleep: pause time between two outpus/excuction
#pyautogui ,time  :import
#.typewrite: takes input
#.press('enter') : automatically press enter key of any app

# here it display text in notepad
#later it will open our app
...
for x in range(2):
      time.sleep(4)
      pag.typewrite(str(x) + ' tharun vjit')
      pag.press('enter')
